...
No full setup guide here; just ensure those exist.
3) Clone
...
5.3 Redirect URI must be exactly: http://127.0.0.1:9090 (the code expects this).
...
and keep local imports working via PYTHONPATH=..
...
playlist_extractor
consolidate_library
9) Common pitfalls on a fresh install
...
That’s it. This repo assumes Zotify is installed separately and used between extractor and consolidate steps.
